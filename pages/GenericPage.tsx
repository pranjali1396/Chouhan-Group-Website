...
const GenericPage: React.FC = () => {
  ...
  const externalSiteUrl = EXTERNAL_SITES[rawTitle];
  ...
  if (isRentals) {
    return (
      <div className="min-h-screen bg-[#002b49] flex flex-col pt-32 md:pt-48">
  ...
  return (
    <div className="min-h-screen bg-white font-sans pt-32 md:pt-48">
      {/* Lightbox Modal */}
          ...
          <div className="flex items-center gap-8 min-w-max">
            {SECTIONS.map((section) => (
              <button
                ...
                className={`py-4 text-xs font-bold uppercase tracking-widest border-b-2 transition-all ${activeTab === section.id
            ...
            {!isSold && (
              <div className="ml-auto flex gap-3">
                {externalSiteUrl && (
                  <a href={externalSiteUrl} target="_blank" rel="noopener noreferrer" className="bg-slate-900 text-white px-6 py-2 text-xs font-bold uppercase tracking-widest hover:bg-slate-800 transition-colors hidden md:block rounded shadow-sm">
                    View Website
                  </a>
                )}
                <a href="#contact" className="bg-amber-500 text-white px-6 py-2 text-xs font-bold uppercase tracking-widest hover:bg-amber-600 transition-colors hidden md:block rounded shadow-sm">
                  Enquire Now
                </a>
              </div>
            )}
