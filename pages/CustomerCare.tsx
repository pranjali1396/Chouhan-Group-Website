...
const CustomerCare: React.FC = () => {
  ...
  return (
    <div className="bg-white font-sans text-slate-800 pt-32 pb-20">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16">
          {(Object.keys(CARE_DATA) as CategoryKey[]).map((key) => (
            <button
              ...
              className={`flex items-center gap-2 px-8 py-4 rounded-full font-bold uppercase tracking-widest text-xs transition-all duration-300 shadow-sm ${
                activeCategory === key 
