            ...
            <div className="grid grid-cols-2 gap-4 mb-10">
              {data.websiteUrl ? (
                <a
                  ...
                  className="bg-[#002b49] text-white py-3.5 px-4 text-[11px] font-bold uppercase tracking-wider hover:bg-slate-800 transition-colors shadow-sm text-center"
                >
                  View Website
                </a>
              ) : (
                <button className="bg-slate-400 text-white py-3.5 px-4 text-[11px] font-bold uppercase tracking-wider cursor-not-allowed shadow-sm">
                  View Website
                </button>
              )}
              <Link to="/contact" className="bg-[#002b49] text-white py-3.5 px-4 text-[11px] font-bold uppercase tracking-wider hover:bg-slate-800 transition-colors shadow-sm text-center">
                Register Today
              </Link>
            </div>
