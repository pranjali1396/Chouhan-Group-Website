...
const COMMERCIAL_PROPERTIES = [
  ...
  },
  {
    ...
    sector: "Office",
    image: "https://images.unsplash.com/photo-1436450412740-6b988f486c6b?q=80&w=1200",
              ...
              <div key={property.id} className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-100 flex flex-col">
                ...
                <div className="relative h-64 overflow-hidden">
                  <div className="absolute top-4 left-4 z-10 flex gap-2">
                    <span className={`backdrop-blur text-white text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded ${
                      property.status === 'Now Selling' ? 'bg-amber-500/80' : 
